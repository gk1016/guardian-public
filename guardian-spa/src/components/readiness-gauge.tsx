      ...
      <div className="flex flex-col items-center gap-1 sm:flex-row sm:gap-6">
        <div className="relative flex-shrink-0">
          <svg width="130" height="75" viewBox="0 0 130 75" className="overflow-visible">
            <path d="M 10 70 A 52 52 0 0 1 120 70" fill="none" stroke="rgba(255,255,255,0.06)" strokeWidth="8" strokeLinecap="round" />
            <path d="M 10 70 A 52 52 0 0 1 120 70" fill="none" stroke={colors.fill} strokeWidth="8" strokeLinecap="round" strokeDasharray={`${circumference}`} strokeDashoffset={`${offset}`} className="transition-all duration-700" />
          </svg>
